...
namespace VI.AWS.AlexaTopSites.Tests
{
    ...
    public class DeserealizationTests
    {
        ...
        public void CatBrowseDeserializationTest()
        {
            ...
            Assert.Equal(186, output.CategoryBrowseResult.Alexa.CategoryBrowse.Categories[0].TotalListingCount);
        }
        ...
        public void CatListingsDeserializationTest()
        {
            ...
            Assert.Equal(882, output.CategoryListingsResult.Alexa.CategoryListings.Listings[0].PopularityRank);
        }
        ...
        public void SitesDeserializationTest()
        {
            ...
            Assert.Equal("linkedin.com", output.SitesLinkingInResult.Alexa.SitesLinkingIn.Sites[1].Title);
        }
